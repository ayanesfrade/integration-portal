...
exports.mimconfig = function(interfacedata) {
	...
	var interfacename = iheader + '_' + interfacedata.sourcenode + '_' + getmimfileName(interfacedata.filenamesample);
